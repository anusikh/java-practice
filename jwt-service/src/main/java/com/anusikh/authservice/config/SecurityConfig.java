    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        return httpSecurity
                .csrf(x -> x.csrfTokenRepository(CookieCsrfTokenRepository.withHttpOnlyFalse())
                        .ignoringRequestMatchers("/new", "/authenticate", "/oauth"))
                .authorizeHttpRequests(x -> x.requestMatchers("/new", "/authenticate", "/oauth").permitAll())
                .authorizeHttpRequests(x -> x.requestMatchers("/welcome").authenticated())
